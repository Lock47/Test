				...
				<div class="leftbox">
					...
					<div class="contentBox">
						...
						<div class="innerContent">
							<form action="<%=basePath%>customer/updatedata" method="post">
								<table class="sysTable" style="text-align: left;">
									<tr>
										<td class="sTitle">
											<span class="important">*</span>客户ID:
											<td>
												<input type="text" name="company_id" value="${companyInfo.company_id}" style="width: 200px;" />
											</td>
										</td>
										<td>
											<span class="important">*</span>客户名称:
											<td>
												<input type="text" name="company_name" value="${companyInfo.company_name}" style="width: 200px;" />
											</td>
										</td>
									...
									<tr>
										<td>
											...
											<td>
												<input type="text" name="company_code"value="${companyInfo.company_code}" style="width: 200px;" />
											</td>
										</td>
									</tr>
									<tr>
										<tr>
											<td class="sTitle">
												...
												<td>
													<input type="text" name="company_license" value="${companyInfo.company_license}
														style="width: 200px;" />
												</td>
											</td>
											<td>
												...
												<td>
													<input type="text" name="company_address" value="${companyInfo.company_address}
														style="width: 200px;" />
												</td>
											</td>
										</tr>
										<tr>
											<td class="sTitle">
												...
												<td>
													<input type="text" name="company_tel" value="${companyInfo.company_tel}" style="width: 200px;" />
												</td>
											</td>
											<td>
												<span class="important">*</span>客户公司性质:
												<td>
													<input type="text" name="company_content" value="${companyInfo.company_content}
														style="width: 200px;" />
												</td>
											</td>
										</tr>
