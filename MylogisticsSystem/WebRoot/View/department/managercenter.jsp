						...
						<table class="sTable">
							...
							<c:forEach items="${list}" var="item">
								<tr class="oddRow">
									...
									<td class="editItem">
										<ul class="editlist">
											<li class="iconEdit"><a href="<%=basePath%>department/update/">编辑</a></li>
											<li class="iconDel"><a onclick="return confirm('您确认要删除当前数据吗？')" href="<%=basePath%>department/delData/">删除</a></li>
										</ul>
									</td>
								</tr>
							</c:forEach>
